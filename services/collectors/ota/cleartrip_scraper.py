"""Cleartrip (cleartrip.com) Flight Scraper & Data Adapter."""
...
class CleartripScraper(BaseOTAScraper):
    """Scrapes Cleartrip domestic flight quotes."""
    ...
    def _generate_calibrated_quotes(
        ...
        for fl in flights_schedule:
            ...
            conv_fee = self.standard_convenience_fee  # ₹349
            discount = 150.0
